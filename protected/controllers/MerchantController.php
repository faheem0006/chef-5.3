...
class MerchantController extends CController
{
	...
	public function beforeAction($action)
	{
		...
		$cs->registerScript(
			Yii::app()->request->baseUrl . '/assets/js/custom.js',
	...
	public function actionAddOnMealPlan()
	{
		$cs = Yii::app()->getClientScript();
		...
		$this->render('create_meal_plan');
	}

	public function actionMealPlanListing()
	{
		$this->render('meal_plan_listing');
	}

	public function actionAddDailySpecial()
	{
		$this->render('add-daily-special');
	}
}
/*END CONTROLLER*/
