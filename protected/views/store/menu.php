...
<div class="sections section-menu section-grey2 z-elevation-2">
	<div class="container" style="width: 95%">
		<div class="row">

			<div class="col-md-12 border menu-left-content">

				<div class="tabs-wrapper z-elevation-5" id="menu-tab-wrapper">
					<ul id="tabs">
						<li class="active">
					...
					<ul id="tab">
						...
						<li class="active" id="menu_left_content">
							<div class="row">
								<div class="col-md-12 col-xs-12 border" id="menu-list-wrapper">
									...
									switch ($admin_activated_menu) {
										...
										default:
											$this->renderPartial('/front/food-card', array(
												'merchant_id' => $merchant_id,
												'menu' => $menu,
												'item_id' => current($menu)['item'][0]['item_id'],
												'disabled_addcart' => $disabled_addcart,
												'tc' => $tc,
...
<button type="button" class="btnn btn--floating" id="btnCart">
