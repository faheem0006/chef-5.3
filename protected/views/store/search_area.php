			...
			<div class="grid">
				...
				<div class="grid-2 left">
					...
					<form id="frm_table_list" method="POST">
						...
						} elseif (isset($_GET['mealplans'])) {
							echo CHtml::hiddenField('mealplans', isset($_GET['mealplans']) ? $_GET['mealplans'] : 'all');
						} elseif (isset($_GET['dailyspecial'])) {
							echo CHtml::hiddenField('dailyspecial', isset($_GET['dailyspecial']) ? $_GET['dailyspecial'] : 'all');
