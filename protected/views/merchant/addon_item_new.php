<h1 class="is-title-lg"><?php echo t("Add a New Meal Plan Dish..") ?></h1>
...
<form class="uk-form uk-form-horizontal forms" id="forms">
  ...
  <div class="uk-grid">
    ...
    <div class="uk-width-full">
      ...
      <?php else : ?>
        ...
        <div class="uk-form-row">
          <label class="uk-form-label"><?php echo Yii::t("default", "Dish Description") ?></label>
          <?php echo CHtml::textField(
              'item_description',
        ...
        <div class="uk-form-row">
          ...
          <?php
            echo CHtml::textField('price', isset($data['price']) ? $data['price'] : "", array(
              'class' => "numeric_only addon_price uk-form-width-large"
            ))
            ?>
        </div>

        <div class="uk-form-row">
          <label class="uk-form-label"><?php echo Yii::t("default", "Cuisines") ?></label>
          <div class="clear"></div>
              ...
              <?php foreach ($subcat as $key => $val) : ?>
                <li>
                  <?php echo CHtml::checkBox(
                          'category[]',
                          in_array($key, (array) $selected_cat) ? true : false,
                          array(
                            'value' => $key,
        ...
        <div class="uk-form-row">
          <label class="uk-form-label"><?php echo t("Add Dish Picture") ?></label>
  ...
  <div class="uk-form-row">
    ...
    <input type="submit" value="<?php echo Yii::t("default", "Save new meal plan") ?>" class="btnn btn--raised" />
  </div>
