...
<h2 class="is-title-lg"><strong>Add Daily Special</strong></h2>
<br />
<div class="container">
    <div class="row">
        <div class="col-md-8 z-elevation-2 has-padding">
            <form class="uk-form uk-form-horizontal forms" id="forms">
                <?php echo CHtml::hiddenField('action', 'DailySpecialAdd') ?>
                ...
                <fieldset>
                    ...
                    <?php if (is_array($size_list) && count($size_list) >= 1) : ?>
                        <ul class="uk-list price_wrap_parent">
                            <li>
                                <div class="uk-grid">
                                    <?php if (isset($merchant_apply_tax) && $merchant_apply_tax == 1) : ?>
