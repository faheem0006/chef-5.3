<div class="login_wrap">
   <div class="uk-panel z-elevation-2 uk-panel-box uk-width-medium-1-3">
      ...
      <form id="forms" class="uk-form forms" onsubmit="return false;" method="POST">
         ...
         <div class="uk-form-row">
            <div class="uk-form-icon uk-width-1">
               ...
               <?php echo CHtml::textField('username', '', array(
                  'class' => "uk-width-1", 'placeholder' => Yii::t("default", "Username"),
         ...
         <div class="uk-form-row">
            <div class="uk-form-icon uk-width-1">
               ...
               <?php echo CHtml::passwordField('password', '', array(
                  'class' => "uk-width-1", 'placeholder' => Yii::t("default", "Password"),
                  'data-validation' => "required"
               )); ?>
            </div>
         </div>
         ...
         <div class="uk-form-row">
            <button class="btnn btn--raised uk-width-1"><?php echo Yii::t("default", "Sign In") ?></button>
         </div>
      </form>
         ...
         <div class="uk-form-row">
            <div class="uk-form-icon uk-width-1">
               ...
               <?php echo CHtml::textField('email_address', '', array(
                  'class' => "uk-width-1", 'placeholder' => Yii::t("default", "Email address"),
                  'data-validation' => "required"
               )); ?>
            </div>
         </div>
      ...
      <form id="mt-frm-activation" class="uk-form mt-frm-activation" onsubmit="return false;" method="POST">
         ...
         <div class="uk-form-row">
            <div class="uk-form-icon uk-width-1">
               ...
               <?php echo CHtml::textField('lost_password_code', '', array(
                  'class' => "uk-width-1", 'placeholder' => Yii::t("default", "Code"),
                  'data-validation' => "required"
               )); ?>
            </div>
         </div>
         ...
         <div class="uk-form-row">
            <div class="uk-form-icon uk-width-1">
               <i class="uk-icon-lock"></i>
               <?php echo CHtml::passwordField('new_password', '', array(
                  'class' => "uk-width-1", 'placeholder' => Yii::t("default", "New Password"),
                  'data-validation' => "required"
               )); ?>
            </div>
         </div>
