...
<div class="z-elevation-2" style="max-width: 800px; padding: 1.5rem; border-radius: 6px; margin: auto">
  <div class="flex flex--align-center flex--justify-between">
    <h1 class="is-title-lg"><?php echo t("Your Information") ?></h1>
    <a href="<?php echo websiteUrl().'/merchant/settings' ?>" class="btnn btn--raised"><?php echo t('change settings instead') ?></a>
  </div>
  <hr />
  <ul data-uk-tab="{connect:'#tab-content'}" class="uk-tab uk-active">
    ...
    <li class=""><a href="#"><?php echo Yii::t("default", "Login Credentials") ?></a></li>
    <?php if ($mtype == 1) : ?>
      ...
      <li class="uk-active">
        <fieldset>
          ...
          <div class="uk-form-row">
            <label class="uk-form-label"><?php echo Yii::t("default", "Profile Assesment") ?></label>
            <?php
            switch ($data['status']) {
              case "expired":
                echo "<span class=\"uk-badge uk-badge-danger\">" . strtoupper(t($data['status'])) . "</span>";
                break;
              case "active":
                echo "<span class=\"uk-badge uk-badge-success\">" . strtoupper(t($data['status'])) . "</span>";
                break;
              default:
                echo "<span class=\"uk-badge uk-badge-notification\">" . strtoupper(t($data['status'])) . "</span>";
                break;
            }
            ?>
          </div>

          <input type="hidden" name="restaurant_slug" value="<?php echo isset($data['restaurant_slug']) ? stripslashes($data['restaurant_slug']) : '' ?>" />

          <br />

          <div class="uk-form-row">
            <label class="uk-form-label"><?php echo Yii::t("default", "Your Restaurant name") ?></label>
          ...
          <div class="uk-form-row">
            <label class="uk-form-label"><?php echo Yii::t("default", "Your Cuisine(s)") ?></label>
