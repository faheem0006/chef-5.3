...
<div id="parallax-wrap" class="parallax-search parallax-menu" data-parallax="scroll" data-position="top" data-bleed="10" data-image-src="<?php echo empty($background) ? assetsURL() . "/images/b-2.jpg" : uploadURL() . "/$background"; ?>">
	...
	<div class="search-wraps center menu-header">
		...
		<h1 class="text-light"><?php echo current(FunctionsV3::getChefName($merchant_id)) ?></h1>

		<p class="text-light">
			<?php echo current(FunctionsV3::getMerchantDishes($merchant_id)[0]) . ' dishes' ?>
			<span>|</span>
			<?php echo 'Mastered Cusine(s): '.FunctionsV3::displayCuisine($cuisine); ?>
		</p>

		<p class="text-light"><i class="fa fa-map-marker"></i> <?php echo $merchant_address ?></p>
